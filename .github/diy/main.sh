...
git clone --depth 1 https://github.com/oppen321/Moll && mv -n Moll/UnblockNeteaseMusic wall/ddns-go wall/gost Moll/smartdns wall/adguardhome Moll/filebrowser ./ ; rm -rf wall
