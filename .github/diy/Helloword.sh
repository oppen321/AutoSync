...
git clone --depth 1 https://github.com/oppen321/Moll && mv -n Moll/* ./ ; rm -rf {UnblockNeteaseMusic,adguardhome,alist,ddns-go,dockerd,filebrowser,gost,lucky,mosdns,sagernet-core,smartdns,ucl,upx-static,upx} && rm -rf Moll
...
git clone --depth 1 https://github.com/sbwml/openwrt_helloworld openwrt_helloworld && mv -n openwrt_helloworld/patch-luci-app-passwall.patch ./ ; rm -rf openwrt_helloworld
