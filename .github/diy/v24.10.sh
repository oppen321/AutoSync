...
git clone --depth 1 https://github.com/oppen321/5G-Modem-Support && mv -n 5G-Modem-Support/{luci-app-hypermodem,luci-app-modem,quectel_cm_5G} ./ && rm -rf 5G-Modem-Support
