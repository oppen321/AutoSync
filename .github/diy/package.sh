...
git clone --depth 1 -b openwrt-24.10 https://github.com/immortalwrt/package && mv -n package/net/{parted,socat,luci-app-syncdial,zerotier} ./ && rm -rf package
git clone --depth 1 -b openwrt-24.10 https://github.com/immortalwrt/package && mv -n package/admin/{netdata} ./ && rm -rf package
